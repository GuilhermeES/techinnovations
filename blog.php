    ...
    <section class="main__hero">
        <div class="container">
            <div class="text-center">
                ...
                <img src="<?php echo get_template_directory_uri() ?>/assets/img/hero-blog.svg" class="img-fluid main__img" alt="">
            </div>
        </div>
    </section>
    ...
    <section class="blog">
        <div class="container">
            <div class="d-block d-md-flex align-items-center justify-content-between">
                <h2 class="blog__title text-center text-md-start"> Blog da Tech Innovations </h2>
            ...
            <div class="blog__list row">
                <?php
                    $query = array('category__not_in' => array( 3 ), 'orderby' => 'date', 'order' => 'DESC', 'post_status' => 'publish');
                    query_posts($query);
                ?>
                <?php if (have_posts()): ?>
